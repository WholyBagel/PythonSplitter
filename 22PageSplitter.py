...
if __name__ == '__main__':
	for filename in glob.glob('*.pdf'):
		...
		pdf_splitter(path,"1", 15,16)
		pdf_splitter(path,"2", 16,17)
		pdf_splitter(path,"3", 17,18)
		pdf_splitter(path,"Demo", 18,19)
		pdf_splitter(path,"App", 19,21)
		pdf_splitter(path,"INS", 21,22)